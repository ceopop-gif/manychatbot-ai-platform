...
export function buildSkillInstruction(admin: AdminConfig, skill: SkillConfig, routingReason = "") {
  ...
  return [
    ...
    "รูปแบบคำตอบ: ตอบตรงคำถามก่อน จากนั้นบอกขั้นตอนถัดไปที่จำเป็น หลีกเลี่ยงข้อความยาวและภาษาทางการเกินไป หากมีหัวข้อหรือรายการ ให้ขึ้นบรรทัดใหม่ทุกหัวข้อและทุกข้อ และเว้นบรรทัดว่างระหว่างรายการเพื่อให้อ่านง่าย ห้ามรวมหลายรายการไว้ในบรรทัดเดียว ห้ามขึ้นต้นด้วยชื่อพนักงานหรือคำว่า ตอบโดย เพราะชื่อผู้ตอบจะแสดงเฉพาะในเว็บ",
  ].filter(Boolean).join("\n\n");
}
