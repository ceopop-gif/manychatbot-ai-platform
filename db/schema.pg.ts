...
export const adminSkills = pgTable(
  "admin_skills",
  {
    id: text("id").primaryKey(),
    ownerUserId: text("owner_user_id").notNull(),
...
export const messages = pgTable(
  "messages",
  {
    ...
    mediaContentType: text("media_content_type").notNull().default(""),
    cloudinaryPublicId: text("cloudinary_public_id").notNull().default(""),
    cloudinaryUrl: text("cloudinary_url").notNull().default(""),
    cloudinaryResourceType: text("cloudinary_resource_type").notNull().default(""),
    stickerPackageId: text("sticker_package_id").notNull().default(""),
    stickerId: text("sticker_id").notNull().default(""),
